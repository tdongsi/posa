...
public class ContentProviderTimeoutCache
    ...
    private int putValues(String acronym,
        ...
        for (int i = 0; i < longForms.size(); i++) {
            // create a ContentValues object that contains
        	...
        	cvArray[i].put(AcronymEntry.COLUMN_FREQUENCY, temp.getFreq());
        	cvArray[i].put(AcronymEntry.COLUMN_SINCE, temp.getSince());
    ...
    public void remove(String acronym) {
        ...
        // delete the row(s) associated with an acronym.
    ...
    public void removeExpiredAcronyms() {
        ...
        // delete expired acronym expansions.
